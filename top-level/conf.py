...
BLOG_AUTHOR = "Steven Cantrell"  # (translatable)
BLOG_TITLE = "Steven Cantrell"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://sacantrell.net/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://sacantrell.net/"
BLOG_EMAIL = "astevencantrell@gmail.com"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/about", "About"),
        ("https://games.sacantrell.net", "Games"),
